...
courses (id INT, title VARCHAR(50))
learners (id INT, name VARCHAR(50))
enrollments (learner_id INT, course_id INT)
...
SELECT learners.name AS name, courses.title AS title
FROM learners
